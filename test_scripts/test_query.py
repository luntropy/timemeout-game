...
# # test en of the game
# data = {'room_id': 5, 'winner': 'host', 'player_id': 5, 'player_role': 'host', 'player_game_score': 50}

# url = 'end_game'
# x = requests.post(BASE + url, json=data)

data = {'attack_type': 1, 'player_id': 5, 'player_role': 'host', 'room_id': 5}
url = 'attack'
x = requests.post(BASE + url, json=data)
